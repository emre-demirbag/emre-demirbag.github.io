...
<style>
  ...
  /* Contain styles so Jekyll theme doesn’t “win” unexpectedly */
  ...
  /* Terminal blocks — force TRUE black */
  .term,
  .termModal,
  .heroTop {
    background: #000;
  ...
  /* Tables — keep theme font + sane sizing */
  table {
    width: 100%;
  ...
  /* Desktop fix: avoid “blank left column” while Definitions table is long */
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              Message Passing Interface: the standard way to coordinate work across nodes. Your
              program runs as multiple processes (ranks) across nodes and exchanges messages. We
              use <strong>OpenMPI</strong> in this guide.
            </td>
          </tr>
          <tr>
            <td class="k"><strong>COW</strong> (Cluster of Workstations)</td>
            <td>
              A “soft” cluster made from machines you don’t fully own/admin. You can still do
              MPI jobs if you have SSH access and consistent environments, but you may not be
              able to wipe/reinstall or run shared services like NFS.
            </td>
          </tr>
          <tr>
